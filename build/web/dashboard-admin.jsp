              ...
              while (businessList.hasMoreElements()){
                ...
                out.print("<div class='event-card'>"
                        ...
                        + "<div class=''>"
                                ...
                                + "<button type='submit' name='approve-btn'value='approve' class='event-card-btn'>Approve</button>"
                                + "<button type='submit' name='reject-btn' value='reject' class='event-card-btn'>Reject</button>"
                                + "</form>"
                        + "</div>"
                       + "</div>");
            }
