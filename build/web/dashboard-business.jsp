                                ...
                                + "<tr>"
                                    + "<td  width=50% >"
                                      ...
                                      + "Details :  "+event.getEventDetails()+"<br>"
                                        ...
                                        + "<button type='submit' name='eventAction' value='something' class='event-card-btn'>Edit Event</button>"
                                        + "<button type='submit' name='eventAction' value='eventDel' class='event-card-btn'>Delete Event</button>"
                                        + "</form>"
                                    + "</td>"
                                    + "<td  width=50% >"
