        ...
        %>
            ...
            <tr>
              <td width=100% height=auto class=main_event_detail>
                ...
                <text>Event Name : <%=event.getEventName() %></text><br>
                <text>Category : <%=event.getCategory() %></text><br>
                
                <text>City : <%=event.getEventCity() %></text><br>
                <text>Details : <%=event.getEventDetails() %></text><br>
