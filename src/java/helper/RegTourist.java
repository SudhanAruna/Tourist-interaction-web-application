...
public class RegTourist {
    ...
    public boolean register(TouristBean tourist) throws SQLException{
        ...
        try {
            ...
            String evntHistoryTable = tourist.getUsername()+"_tourist_event_history";
            
            String sqlQuery = "INSERT INTO `tourist-user`(`firstName`, `lastName`, `emailAdd`, `username`, `password`, `dob`, `contactNumber`, `addNo`, `addStreet1`, `addStreet2`, `city`, `postalCode`, `country`,`evntHistory`) "
                    + "VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
        
                  String sqlQueryCreateTable = "CREATE TABLE "+evntHistoryTable
            ...
            stm.setString(14, evntHistoryTable);
